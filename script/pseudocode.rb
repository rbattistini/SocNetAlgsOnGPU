...
# Taken from the Python lexer used in Rouge and modified to
# highlight a custom pseudocode language.
    ...
    class Pseudo < RegexLexer
      ...
      def self.keywords
        @keywords ||= %w(
          ...
          return try while yield as with import yield
          async await nonlocal end do then let
        )
      end
